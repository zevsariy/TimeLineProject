...
class TimelinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeline" do
    assert_difference('Timeline.count') do
      post timelines_url, params: { timeline: { description: @timeline.description, title: @timeline.title, user_id: @timeline.user_id } }
    end
  ...
  test "should update timeline" do
    patch timeline_url(@timeline), params: { timeline: { description: @timeline.description, title: @timeline.title, user_id: @timeline.user_id } }
